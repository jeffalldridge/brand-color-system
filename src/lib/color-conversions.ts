...
export function oklchToHex(l: number, c: number, h: number, gamut: GamutTarget = 'srgb'): string {
...
export function oklchToRgbString(l: number, c: number, h: number, gamut: GamutTarget = 'srgb'): string {
  const color = { mode: 'oklch' as const, l, c, h };
  const mapped = getGamutMapper(gamut)(color);
  return formatRgb(mapped);
}

export function oklchToHslString(l: number, c: number, h: number, gamut: GamutTarget = 'srgb'): string {
  const color = { mode: 'oklch' as const, l, c, h };
  const mapped = getGamutMapper(gamut)(color);
...
export function oklchToRgbValues(l: number, c: number, h: number, gamut: GamutTarget = 'srgb'): { r: number; g: number; b: number } {
  const color = { mode: 'oklch' as const, l, c, h };
  const mapped = getGamutMapper(gamut)(color);
